...
thr_udpListen(void * arg){
  ...
  #ifdef __APPLE__   // MacOS/X requires an additional call also. Added by Herman Stavelin
   setsockopt(threadListItem->socket, SOL_SOCKET, SO_REUSEPORT, &optval, sizeof(optval));
  #endif
